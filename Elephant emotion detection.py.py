...
def extract_features(audio, sample_rate, mfcc=True, chroma=True, mel=True):
    ...
    cutoff_frequency = 20.0  # Adjust the cutoff frequency as needed
...
audio_file_path = r"D:\SEM 3\DSP\# PROJ\INPUT\INPUT_3.wav"
...
data = pd.read_csv(r"D:\SEM 3\DSP\# PROJ\# FINAL\DATASET\emotion_dataset_3.csv")
